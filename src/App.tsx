    ...
    <div className="relative min-h-screen bg-[#09090B] overflow-hidden flex flex-col items-center justify-center selection:bg-[#D6F248] selection:text-black">
      ...
      <div className="relative z-10 container mx-auto px-6 md:px-8 flex flex-col items-center text-center">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <span className="text-white text-6xl md:text-7xl lg:text-[80px] font-bold tracking-tighter leading-[0.9]">
            elio
        ...
        >
          <h1 className="font-medium tracking-tight leading-[1.05]">
            <span className="text-white/90 text-3xl md:text-5xl lg:text-6xl block mb-3 font-normal">
              Your Solana Stablecoins Wallet
            </span>
            <span className="text-white text-5xl md:text-7xl lg:text-8xl block">
              The Future is <span className="text-serif-italic text-[#D6F248]">Instant</span>
            </span>
            <span className="text-[#71717A] text-2xl md:text-4xl lg:text-5xl block mt-4 font-normal">
        ...
        >
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group relative bg-[#18181B] hover:bg-[#D6F248] border border-white/10 hover:border-[#D6F248] text-white hover:text-black h-14 px-7 rounded-2xl font-medium transition-all duration-300 flex items-center justify-center gap-3 shadow-lg shadow-black/20 hover:shadow-[#D6F248]/20"
          >
          ...
          <a
            ...
            className="h-14 flex items-center justify-center transition-all duration-300 hover:scale-105 hover:brightness-110"
          >
      ...
      <motion.div
        ...
        className="absolute bottom-6 md:bottom-8 left-0 right-0 text-center space-y-2"
      >
        <div className="flex items-center justify-center gap-5 text-[#52525B] text-xs">
        ...
        <p className="text-[#3F3F46] text-[11px] pt-2">© 2026, All rights reserved</p>
      </motion.div>
    </div>
  );
};
