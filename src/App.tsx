      ...
      <div className="relative z-10 container mx-auto px-4 flex flex-col items-center text-center">
        ...
        >
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="bg-[#18181B] hover:bg-white hover:text-black border border-white/10 text-white h-14 px-6 rounded-xl font-medium transition-all duration-300 flex items-center justify-center gap-3 group"
          >
