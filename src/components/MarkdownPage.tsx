...
const proseStyles = `prose prose-invert prose-gray max-w-none 
  ...
  [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:mb-4 [&_ul]:text-[#A1A1AA]
  [&_li]:mb-2
  [&_table]:w-full [&_table]:mb-6 [&_table]:border-collapse
  [&_th]:text-left [&_th]:p-3 [&_th]:bg-white/5 [&_th]:border [&_th]:border-white/10 [&_th]:text-white
  [&_td]:p-3 [&_td]:border [&_td]:border-white/10 [&_td]:text-[#A1A1AA]
  ...
  return (
    <Layout>
      <div className="container max-w-3xl pb-20 pt-10">
        ...
        <Link
          to="/"
          className="inline-flex items-center text-[#D6F248] hover:text-white transition-colors mt-12 font-medium"
        >
          ← Back to Home
        </Link>
      </div>
